...
from train_agent.eval.restricted_ranking import DOCUMENT_AGGREGATIONS, evaluate_restricted_ranking_episodes
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--doc_aggregation", choices=DOCUMENT_AGGREGATIONS, default="full_document")
